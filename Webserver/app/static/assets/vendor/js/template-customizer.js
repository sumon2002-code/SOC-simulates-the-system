            ...
            E = function() {
                function t(e) {
                    ...
                    if (function(t, e) { if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function") }(this, t), !this._ssr) {
                        ...
                        if (this.settings = {}, this.settings.cssPath = s, this.settings.themesPath = i, this.settings.cssFilenamePattern = a || "%name%.css", this.settings.displayCustomizer = void 0 === o || o, this.settings.controls = n || b, this.settings.defaultTextDir = "rtl" === l || z, this.settings.defaultLayoutType = r || T, this.settings.defaultMenuCollapsed = void 0 !== c ? c : k, this.settings.defaultMenuFlipped = void 0 !== u ? u : F, this.settings.defaultShowDropdownOnHover = void 0 !== d ? d : void 0, this.settings.defaultNavbarFixed = void 0 !== h ? h : C, this.settings.defaultFooterFixed = void 0 !== p ? p : A, this.settings.availableThemes = f || t.THEMES, this.settings.defaultTheme = this._getDefaultTheme(void 0 !== g ? g : w), this.settings.styles = m || _, this.settings.defaultStyle = y || S, this.settings.lang = E || "en", this.pathResolver = v || function(t) { return t }, this.settings.styles.length < 2) { var N = this.settings.controls.indexOf("style"); - 1 !== N && (this.settings.controls = this.settings.controls.slice(0, N).concat(this.settings.controls.slice(N + 1))) }
                ...
                var e, s;
                return e = t, s = [{ key: "setRtl", value: function(t) { this._hasControls("rtl") && (this._setSetting("Rtl", String(t)), window.location.reload()) } }, { key: "setStyle", value: function(t) { this._hasControls("style") && (this._setSetting("Style", -1 === ["dark"].indexOf(t) ? "light" : t), window.location.reload()) } }, {
                    key: "setTheme",
                    value: function(t) {
                ...
                }, { key: "_loadingState", value: function(t, e) { this.container.classList[t ? "add" : "remove"]("template-customizer-loading".concat(e ? "-theme" : "")) } }, { key: "_getElementFromString", value: function(t) { var e = document.createElement("div"); return e.innerHTML = t, e.firstChild } }, {
                    key: "_getSetting",
                    value: function(t) {
                        var e = null,
                ...
                }, { key: "_getDefaultTheme", value: function(t) { var e; if (!(e = "string" == typeof t ? this._getThemeByName(t, !1) : this.settings.availableThemes[t])) throw new Error('Theme ID "'.concat(t, '" not found!')); return e } }, {
                    key: "_getThemeByName",
                    value: function(t) {
